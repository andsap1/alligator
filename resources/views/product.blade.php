        ...
        <div class="col-lg-10 offset-lg-1">
            ...
            @foreach($allPro as $asPro)
                <tr>
                    ...
                    <td>{{ $asPro->fk_prekes_kategorija }}</td>
                    ...
                    <td width="50"><button class="button" type="delete" onclick="return confirm('Do you really want to delete this product?')"><svg class="bi bi-x-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
